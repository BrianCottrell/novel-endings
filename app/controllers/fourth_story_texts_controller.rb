class FourthStoryTextsController < ApplicationController
  $page = 1
  ...
  def update
    @fourth_story_text = FourthStoryText.find(params[:id])
    #
    respond_to do |format|
      if @fourth_story_text.update(params.require(:fourth_story_text, :passage))
        format.html{redirect_to @fourth_story_text, notice: 'Story text was successfully updated.'}
